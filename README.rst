...
.. |commits-since| image:: https://img.shields.io/github/commits-since/insertjokehere/python-hassdevice/v0.1.4.svg
    :alt: Commits since latest release
    :target: https://github.com/insertjokehere/python-hassdevice/compare/v0.1.4...master

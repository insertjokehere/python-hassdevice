...
.. |commits-since| image:: https://img.shields.io/github/commits-since/insertjokehere/python-hassdevice/v0.0.1.svg
    :alt: Commits since latest release
    :target: https://github.com/insertjokehere/python-hassdevice/compare/v0.0.1...master
